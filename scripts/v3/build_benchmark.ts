#!/usr/bin/env node
/**
 * SiftrCode V3 - Build Benchmark Script (Phase V3.1A & B)
 *
 * Assembles SiftrBench v1 episodes, validates invariants, partitions leakage-safe splits,
 * and emits signed benchmark and split manifests.
 */

import * as fs from 'fs';
import * as path from 'path';
import { BenchmarkBuilder } from '../../src/benchmark/siftrbench/benchmark_builder';
import { SplitManager } from '../../src/benchmark/siftrbench/split_manager';

export function runBuildBenchmark() {
