...
const { LinearPairwiseRanker } = require('../../dist/learning/models/context_rank/linear_pairwise_ranker');
const { RankingMetricsCalculator } = require('../../dist/learning/evaluation/ranking_metrics');
const { TaskLevelBootstrap } = require('../../dist/learning/evaluation/bootstrap');
const { AblationRunner } = require('../../dist/learning/evaluation/ablation_runner');
const { featuresToVector } = require('../../dist/learning/features/feature_set_v3_1');

function runEvaluateContextRank() {
  ...
  const testRowsByEpisode = new Map();
  ...
  const finalReport = {
    ...
    heldOutEpisodeCount: testAssignments.length,
...
module.exports = { runEvaluateContextRank };
